 ...
 * @author Adhiraj
 */
public class VisaApplication extends javax.swing.JFrame {
    ...
    public VisaApplication(Login login) {
        this.login = login;
        radioButtonGroup.add(maleRadioButton);
        radioButtonGroup.add(femaleRadioButton);
        getAllCountries();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisaApplication.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
